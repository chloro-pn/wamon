...
TEST(builtin_type_method, basic) {
  ...
  auto return_type = wamon::BuiltInTypeMethod::Instance().CheckAndGetReturnType(builtintype, "len", {});
  ...
  return_type = wamon::BuiltInTypeMethod::Instance().CheckAndGetReturnType(builtintype, "at", params);

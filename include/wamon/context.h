...
class Context {
 public:
  ...
  explicit Context(const std::string& type_name, const std::string& method_name)
      : type_(ContextType::METHOD), method_context_type_name_(type_name), method_context_method_name_(method_name) {}

  explicit Context(const std::string& func_name) : type_(ContextType::FUNC), func_context_func_name_(func_name) {}
